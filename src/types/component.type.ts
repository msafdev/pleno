import type { TOCItem, ReadingTime } from './content.type'
...
// GitHub contribution day entry
export interface ContributionDay {
  contributionCount: number
  date: string
}

// Weekly contribution data (array of days)
...
// Cached GitHub contribution data
export interface CachedContribData {
  data: GitHubContribData
  timestamp: number
}

// GitHub contribution card UI elements
export interface ContribCardElements {
